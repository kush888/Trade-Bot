...
#     print (df)
    fileName = "6 years 1 hr interval data"
...
#     test_agent(test_df,test_df_nomalized, visualize=False, folder="2021_02_21_17_54_Crypto_trader", name="3447.20_Crypto_trader" )
...
#     train_agent(train_env, agent, visualize=False, train_episodes=32, training_batch_size=500)
    ...
    print ("START")
    time = datetime.now()
    train_multiprocessing(CustomEnv, agent, train_df, train_df_nomalized, num_worker = 32, training_batch_size=500, visualize=False, EPISODES=32)
...
#     test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 16, visualize=False, test_episodes=1000, folder="2021_02_21_17_54_Crypto_trader", name="3447.20_Crypto_trader", comment="3 months")
